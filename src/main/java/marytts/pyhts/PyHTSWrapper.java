...
public class PyHTSWrapper {
    ...
    public Utterance synthesizeHMM(PyHTSVoice v, Utterance input_utt, Serializer label_serializer, boolean imposed_dur) throws IOException, InterruptedException, MaryException, UnsupportedAudioFileException {
